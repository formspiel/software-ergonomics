...
_Hinweis: Die Komponente gibt es als [Sketch-Symbol zur UI-Konzeption](/)_

## Code

``` html
<select class="dsx-drop-down--standard" name="">
...
* der Fokus geht auf das Drop-Down-Element zurück
  * der Nutzer kann jederzeit die Optionen mit der Taste <kbd>Ecs</kbd> schließen
  * der Fokus geht dann zum Drop-Down-Element zurück

#### Automatisiertes Testen
Gherkin Dateien:
Mach mit! Du hast bereits eine Test für das Element geschrieben? Bitte teile Dein Skript, oder hinterlege einen Link zum Deinem Repository.
...
* Alle Zustände und Optionen (inkl. Auswahl) sind im Hochkontrastmodus erkennbar.
