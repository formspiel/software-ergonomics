...
function newPopup(url) {
	var popupWindow = window.open(
		url,'popUpWindow','height=350,width=700,left=500,top=400,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes,noopener=yes')
}
